...
// void WorkflowPlanner::pick_up_accepted(const std::shared_ptr<GoalHandlerPick> goal_handle)
// {
//   std::thread{std::bind(&WorkflowPlanner::pick_up_execution, this, _1), goal_handle}.detach();
// }

// void WorkflowPlanner::pick_up_execution(const std::shared_ptr<GoalHandlerPick> goal_handle)
// {
